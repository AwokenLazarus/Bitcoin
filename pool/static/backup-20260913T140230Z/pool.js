(() => {
  ...
  function payoutFlow(p, cb, value) {
    ...
    set("cb-flow-pool", poolSats > 0
      ? t("payout.flow.pool", { amt: amtSats(poolSats), pct: pct(100 * poolSats / value, 2), carryTotal: amtSats(carryTotal), holders: num(cb.carry_holders || 0) })
      : t("payout.flow.poolNone", { carryTotal: amtSats(carryTotal), holders: num(cb.carry_holders || 0) }));
